...
#elbow plot to pick number of clusters (doesn't work very well)
inertias = []
K_range = range(2, 26)
...
#most common aspects (task, handle, power play)
...
######## K MEANS CLUSTERING FOR CLASSIFYING POINTS 0-4 #############
...
######### KNN FOR CLASSIFYING POINTS 0-4 #########
...
########## MLP NEURAL NETWORK FOR CLASSIFYING POINTS 0-4 #########
